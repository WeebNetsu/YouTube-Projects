...
const CreatePost: React.FC<CreatePostProps> = ({ fetchParentData, show, setShow }) => {
    ...
    const handleSubmitPost = async () => {
        ...
        if (cleanedText.length > MAX_POST_LENGTH) return message.error('Post text is too long');
    ...
    return (
        <Flex style={{ width: '100%' }} gap={'large'}>
            <Input.TextArea value={postText} onChange={(e) => setPostText(e.target.value)} />
